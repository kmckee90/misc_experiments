...
import tiktoken
import torch
from model import GPTConfig, ReservoirGPT
...
if init_from == "resume":
    ...
    model = ReservoirGPT.from_pretrained(init_from, dict(dropout=0.0))
    ...
    with torch.no_grad():
        with ctx:
            for k in range(num_samples):
                ...
                print("---------------")
#                prevtext = prevtext + decode(y[0].tolist())

#    start = prevtext + start
