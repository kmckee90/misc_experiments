...
class EnhancedSpiking1024(nn.Module):
    """
    Enhanced spiking neural network at 1024x1024 resolution.
    """
    def __init__(self):
        super().__init__()
...
def export_enhanced_1024_onnx():
    """Export enhanced spiking neural network at 1024x1024 resolution."""

    model = EnhancedSpiking1024().eval()
    ...
    print("✓ Exported enhanced ONNX model to spiking_step_enhanced_1024.onnx")
    print("✓ Resolution: 1024x1024")
    print("✓ Includes: dropout, local/global exc/inh connections")

if __name__ == "__main__":
    export_enhanced_1024_onnx()